...
The resources used for this exercise are contained in the folder named Resources. The raw data is named election_results.csv.

### Analysis

The final output will be found in the Analysis folder in the election_results.txt file.

### Code

The code written to create the output is found in the PyPoll_Challenge.py file. The code is also provided below:
